 ...
 */
package ua.ri.assigment4.tokenizer;
...
import ua.ri.assigment4.Stemmer.Stemmer;
import ua.ri.assigment4.stopWords.StopWords;
...
public class Tokenizer extends SimpleTokenizer{   
    ...
    public List splitBySpacePeriodSpace(String text) {
        // Remove all non-alphabetic characters and pontuation marks
